      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-md border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-bold text-slate-500">
            <a href="#features" className="hover:text-blue-600 transition-colors">Galimybės</a>
            <a href="#search" className="hover:text-blue-600 transition-colors">Analizė</a>
            <Link to="/analytics" className="hover:text-blue-600 transition-colors">Analitikos centras</Link>
            <Link to="/analytics/deep-evaluation" className="bg-slate-900 text-white px-5 py-2.5 rounded-full hover:bg-blue-600 transition-all">
              Vertinti adresą
            </Link>
          </div>
        </div>
